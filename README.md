...
Modify this path in the notebook:
...
Field-deployable AI for poultry diagnostics.

Contributions by bvumesh
...
Feel free to use, modify, or extend for research or deployment!
